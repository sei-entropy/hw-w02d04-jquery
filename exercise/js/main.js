...
$("#button2").on('click',changeBackgroundColor);
 ...
 */
const changeColorHeading = function(){
$("h2").css("color","green");
}
$("#button2").on("click",changeColorHeading);

/**
 * Question 6:
 * When button 2 is clicked, change the html content of all "blockquotes" to be "<span>no quote</span>"
 */
const chnageHtmlContent = function(){
	$("blockquote").html("<span>no quote</span>");
}
$("#button2").on("click",chnageHtmlContent);
 ...
 */
const changeTextHeader = function(){
$("h1").html("jQuery Ninja");
}
$("#button3").on("click",changeTextHeader);
